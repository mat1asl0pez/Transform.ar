...
<body>
  ...
  <nav class="navbar navbar-light bg-light">
    <a class="navbar-brand" href="inicio.php"><img src="../img/logo.jpg" width="40" height="40" class="imagen"></a>
    <!--MI CUENTA-->
    <div class="botones">
      <a button class="btn" href="foro.php">Foro</a></button>
      <a button class="btn" href="perfil.php">Mi cuenta</a></button>
          ...
          <div class="card-body">
            <div class="card text">
              ...
              <div class="row">
                ...
                <div class="acciones col-1"><br>
                  <div class="pin"> <i class="fas fa-thumbs-up"></i>
                  </div>
                </div>
                ...
                <div class="col-8"><br>
                  ...
                  <p class="card-text">
                    ...
                    <a href="https://www.facebook.com/defensorialgbt">Defensoria LGBT</a>
                    <br>
                    <i class="fas fa-mouse-pointer"></i>
                    <a href="https://www.defensoria.org.ar">defensoria.org.ar</a>
                    <br>
                    <i class="fab fa-facebook-square"></i>
                    <a href=" https://www.facebook.com/ATTTAOFICIAL">ATTTA RED NACIONAL</a>
                    <br>
                    <i class="fas fa-mouse-pointer"></i>
                    <a href="www.attta.org.ar">ATTTA.ORG.AR</a>
                    <br>
                    <i class="fab fa-facebook-square"></i>
                    <a href="https://www.facebook.com/FALGBT">Federación Argentina LGBT</a>
                    <br>
                    <i class="fas fa-mouse-pointer"></i>
                    <a href="https://www.falgbt.org">falgbt.org</a>
                    <br>
                    <i class="fab fa-facebook-square"></i>
                    <a href="https://www.facebook.com/CasaTransCABA">CASA TRANS (CABA)</a>
                    <br>
                    <i class="fab fa-facebook-square"></i>
                    <a href="https://www.facebook.com/mochacelis">Bachillerato Mocha Celis</a>
                    <br>
                    <i class="fas fa-mouse-pointer"></i>
                    <a href="www.bachilleratomochacelis.edu.ar">bachilleratomochacelis.edu.ar</a>
                    <br><br>
                  </p>
                </div>
              </div>
            ...
            <div class="card text">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-8">
                    <p class="card-text"><h4>ARTICULO 1º — Derecho a la identidad de género.</h4>
              ...
              <div class="card text">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-8">
                      <h4 class="card-title">Hormonización:</h4>
                      <p class="card-text">Consiste en la administración de distintos fármacos con la finalidad de modificar algunos
                        ...
                        ya que es muy imporante obtener información sobre los alcances y los límites de la hormonización, como también los
                        beneficios y los posibles efectos adversos que estar prácticas pueden tener.<br>
                        <ins>Requisitos:</ins>
                ...
                <div class="card-header">#hormonas
            </div>
              </div>
            </div>
            <br>
              ...
              <div class="card text">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-8">
                      <h4 class="card-title">Intervenciones:</h4>
                      <p class="card-text">Existen distintos tipos de cirugías de modificación corporal a los que pueden recurrir
                ...
                <div class="card-header">#intervenciones
            </div>
